...
![Tracked CPT rig set up on site among pine trees](blured.png)
*A tracked CPT rig on site, one of the soundings that fed straight into the DIGGS pipeline described below.*
